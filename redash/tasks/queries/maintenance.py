...
def refresh_schema(data_source_id):
    ...
    logger.info("task=refresh_schema state=start ds_id=%s ds_name=%s", ds.id, ds.name)
    ...
    try:
        ...
        logger.info("task=refresh_schema state=skip ds_id=%s reason=not_supported", ds.id)
